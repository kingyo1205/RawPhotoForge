...
class ToneCurveWidget:
    ...
    def setup_plot(self):
        ...
        if self.curve_type == "brightness":
            ...
            colors = raw_image_editor.oklch_to_rgb_vectorized(L, C, H)
...
class RAWDevelopmentGUI:
    ...
    def __init__(self):
        ...
        # 初期化
        self.editor: raw_image_editor.RAWImageEditor = None
        self.medium_editor: raw_image_editor.RAWImageEditor = None
        self.small_editor: raw_image_editor.RAWImageEditor = None
    ...
    def apply_parameters_to_editor(self, editor: raw_image_editor.RAWImageEditor):
        """編集パラメータをエディターに適用"""
        if editor is None:
            return
