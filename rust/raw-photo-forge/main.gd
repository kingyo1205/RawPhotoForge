...
func _ready() -> void:
    ...
    var pc_scale: float = DisplayServer.screen_get_scale(DisplayServer.SCREEN_OF_MAIN_WINDOW)
    print("DisplayServer.screen_get_scale: ", pc_scale)
    get_window().content_scale_factor = pc_scale
