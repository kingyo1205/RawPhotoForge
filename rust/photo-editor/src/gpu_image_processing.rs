...
impl GpuProcessor {
    pub async fn new(adapter_index: usize) -> Result<Self, PhotoEditorError> {
    ...
    pub fn apply_adjustments(
        ...
        for mask in masks_data {
            ...
            gpu_params.push(GpuEditParameters {
                ...
                vignette: params.vignette as f32,
    ...
    pub async fn get_adapter_string_list() -> Vec<String> {
        let instance = wgpu::Instance::new(wgpu::InstanceDescriptor::new_without_display_handle());
        instance
    ...
    pub async fn get_adapter_list() -> Vec<wgpu::Adapter> {
        let instance = wgpu::Instance::new(wgpu::InstanceDescriptor::new_without_display_handle());
