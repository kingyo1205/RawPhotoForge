...
ExifTool は GPL 1.0以降 または Artistic License 1.0 のデュアルライセンスですが、本ソフトウェアはAGPLとの整合性を確保するため、ExifToolを **GNU General Public License (GPL) version 3** の条件に基づいて使用しています。

詳細は [公式ページ](https://exiftool.org/) をご覧ください。
